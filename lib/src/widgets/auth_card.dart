...
class _LoginCardState extends State<_LoginCard> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _nameController =
        TextEditingController(text: auth.email != '' ? auth.email : _email);
  ...
  Widget _buildUserNameField(double width, LoginMessages messages, Auth auth) {
    return AnimatedTextFormField(
      ...
      validator: !auth.isLogin ? widget.userNameValidator : null,
        ...
        children: [
          ...
          Container(
            padding: EdgeInsets.only(
              ...
              right: cardPadding,
              // bottom: !isLogin ? 10 : 0,
              bottom: widget.isUserNameRequire ? !isLogin ? 10 : 3 : 0,
              top: !widget.isUserNameRequire
                  ? cardPadding + 10
                  : isLogin ? cardPadding + 10 : cardPadding,
            ),
            // color: Colors.blue,
            width: cardWidth,
            child: Column(
          ...
          ExpandableContainer(
            ...
            padding: EdgeInsets.symmetric(
              horizontal: cardPadding,
              vertical: !widget.isUserNameRequire ? 10 : 8,
            ),
